...
namespace EnvisionStaking.Casper.SDK.HowToGuides.Undelegate
{
    class Program
    {
        static async Task Main(string[] args)
        {
            try
            {
                ...
                var transferResult = client.DeployService.Undelegate(amountToUndelegate, delegateAccount, validatorAccount, id, publicKeyLocation, privateKeyLocation, Enums.SignAlgorithmEnum.ed25519, chainName);
